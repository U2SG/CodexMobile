...
// Use path.resolve so fixtures land on the same drive prefix the SUT produces
// (Windows: D:\tmp\..., POSIX: /tmp/...). buildSessionIndex calls
// path.resolve() internally and Windows' resolve prepends a drive letter.
const TMP = path.resolve('/tmp');
const tmp = (sub) => path.join(TMP, sub);
