// useDocsActions — owns the five Feishu / lark-cli docs panel handlers
// that App.jsx used to inline (handleConnectDocs, handleDisconnectDocs,
// handleRefreshDocs, handleOpenDocsHome, handleOpenDocsAuth). Pure
// refactor (Stage 2 R11) — same endpoints, same `docsBusy` gating,
// same window.location.assign navigation, same error-text surface
// through `setDocsError`.
